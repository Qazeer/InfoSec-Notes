...
way to upload file using multiple echo commands in order to write a
...
MSSQL_SERVER="<IP>"
# Windows authentication (Windows local or AD domain account)
MSSQL_USERNAME = "<DOMAIN | WORKGROUP>\\<USERNAME>"
