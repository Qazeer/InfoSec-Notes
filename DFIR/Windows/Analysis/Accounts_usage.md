...
events related to Windows logon into an output `CSV` file.

The following `events ID` are processed: 4624, 4625, 4634, 4647, 4648, 4772,
4778, 4779, 4800, 4801, 4802, and 4803.
...
|----------|----------|------------|-------------|
| EVTX | `Security.evtx` | Default configuration. | Event `4624: An account was successfully logged on`. |
...
| EVTX | `Security.evtx` | Default configuration. | Event `4672: Special privileges assigned to new logon`. <br><br> **Only logged for the privileged logons on the Domain Controller itself.** |
...
#### Destination machine events details
