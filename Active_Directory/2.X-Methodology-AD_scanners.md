...
# --dns-tcp: The DNS queries will be made over TCP instead of UDP, usefull to enumerate over SOCKS4 proxies which do not support the UDP protocol
bloodhound-python -v -dc <DC_HOSTNAME> -ns <DNS_SERVER_IP> -d <DOMAIN_FQDN> -u <USERNAME> -p <PASSWORD> -CollectionMethod  <all | DcOnly | <COLLECTION_METHOD>
```
...
# Membership of Everyone, Anonymous, Authenticated Users, Domain Users or Domain Computers to the local Administrators group in all of the domain computers
...
# Possible code execution of Everyone, Anonymous, Authenticated Users, Domain Users or Domain Computers to all domain computers
...
# Finds where the specified domain user is member of the local Administrator group.
