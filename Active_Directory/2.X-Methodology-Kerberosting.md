...
#### Automated discovery, request and export
...
#### Manual request and export Service Tickets
...
```
# Its recommended to use Hashcat on a Windows OS for better driver compatibility
