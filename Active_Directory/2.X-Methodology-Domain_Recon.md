...
To list the shares accessibles on a computer the following commands can be used:
...
```
# Windows
net use \\<HOSTNAME/IP>\<SHARE> "" /user:"" # NULL session
net use \\<HOSTNAME/IP>\<SHARE> /user:"<DOMAIN>\<USERNAME>"
